...
public class TrabalhadorService {
    ...
    public TrabalhadorResponseDTO findById(Long id) {
        ...
        return modelMapper.map(repository.findById(id).orElseThrow(() -> new EntityNotFoundException("Trabalhador não encontrado com ID: " + id)), TrabalhadorResponseDTO.class);
    }
