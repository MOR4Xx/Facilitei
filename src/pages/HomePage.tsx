...
function UsersIcon(props: React.ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0-3.742-.72m-4.5 0a9.094 9.094 0 0 0-3.742.72M18 18.72V5.25A2.25 2.25 0 0 0 15.75 3H8.25A2.25 2.25 0 0 0 6 5.25v13.5m12 0v-2.25a4.5 4.5 0 0 0-9 0v2.25m9 0h-9m9 0-9-10.5m9 10.5-9-10.5m0 0a4.5 4.5 0 1 1 9 0m-9 0a4.5 4.5 0 1 0 9 0" />
    </svg>
  );
}
  ...
  return (
    ...
    >
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <motion.div variants={itemVariants} className="text-center md:text-left">
            ...
            <div className="mt-10 flex justify-center md:justify-start gap-4">
              <Link
                to="/dashboard/solicitar" // Link direto para solicitar
      ...
      <motion.section variants={itemVariants}>
        ...
        <Typography as="p" className="text-center !text-lg text-dark-subtle max-w-2xl mx-auto mb-16">
      ...
      <motion.section variants={itemVariants} className="text-center">
        <Typography as="h2" className="!text-4xl mb-6">
         ...
         <Typography as="p" className="text-center !text-lg text-dark-subtle max-w-2xl mx-auto mb-12">
          Os serviços mais buscados na plataforma.
        </Typography>
        <div className="flex flex-wrap gap-4 justify-center">
          {['Eletricista', 'Pedreiro', 'Encanador', 'Ar Condicionado', 'Pintor', 'Fretes'].map(cat => (
             <span
                key={cat}
