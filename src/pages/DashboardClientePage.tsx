...
import { TrabalhadorCard } from "../components/ui/TrabalhadorCard"; // 👈 IMPORTADO AQUI
...
export function DashboardClientePage() {
  ...
  const totalServicosAtivos =
    servicos?.filter((s) => s.statusServico !== "FINALIZADO").length || 0;
